...
class ToSCommands(commands.Cog):
        ...
        options=[
            create_option(
                ...
                choices=[
                    ...
                    create_choice(
                        name="Betrayal.io",
                        value="Betrayal.io|773336526917861400"
                    ),
                    create_choice(
                        name="Fishingtron.io",
                        value="Fishingtron.io|814288819477020702"
                    ),
                    create_choice(
                        name="Poker Night",
                        value="Poker Night|755827207812677713"
                    ),
                    create_choice(
    ...
    async def _discordactivity(
        ...
        if not voice:
            await ctx.send(hidden=True, content='You have to be in a voice channel to use this command.')
            return
