...
error_codes_and_responses = {
    ...
    "NoToken": f"""{{discord_member.mention}} registration is outdated \nPlease {_client.get_command_by_name("register").mention()} again""",
