...
class GetMemberCount(BaseEvent):
    ...
    async def run(self, client):
        ...
        for guild in client.guilds:
            ...
            await channel.edit(name=f"𝖬𝖾𝗆𝖻𝖾𝗋᲼𝖢𝗈𝗎𝗇𝗍᲼｜᲼{guild.member_count}", reason="Member Count Update")
...
class GetBoosterCount(BaseEvent):
    ...
    async def run(self, client):
        ...
        for guild in client.guilds:
            ...
            # update the name
            await channel.edit(name=f"𝖡𝗈𝗈𝗌𝗍𝖾𝗋᲼𝖢𝗈𝗎𝗇𝗍 ᲼｜᲼{guild.premium_subscription_count}", reason="Booster Count Update")
