...
from Website.database.psql_credentials import password, ssh_port, dbname, host, ssh_host, ssh_password, user, ssh_user
from Website.database.database_models import database_tables
...
async def insertPgcrActivities(
    instanceId,
    referenceId,
...
async def insertPgcrActivitiesUsersStats(
    instanceId,
    membershipId,
    characterId,
    characterClass,
...
async def get_info_on_low_man_activity(
    activity_hashes: list,
    player_count: int,
    destiny_id: int,
...
async def insertPgcrActivitiesUsersStatsWeapons(
    instanceId,
    characterId,
    membershipId,
    weaponId,
