...
permissions_admin = {
    280456587464933376: generate_permissions(allowed_roles=[280459773428891648]),  # @Admin id
}

# this allows socialists to run the command
permissions_socialist = {
    280456587464933376: generate_permissions(allowed_users=[238388130581839872]),  # @Kigstn id
}
...
permissions_kigstn_hali = {
    280456587464933376: generate_permissions(allowed_users=[238388130581839872, 219517105249189888]),  # @Kigstn id, @hali id
}
