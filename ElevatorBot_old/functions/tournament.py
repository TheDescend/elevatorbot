...
class Tournament:
    ...
    async def playTournament(self, client, tourn_channel):
        ...
        # loops through the bracket and plays the misc
            ...
            if to_play:
                if len(to_play) == 2:
                    bracket[0], bracket[1] = await asyncio.gather(
                        *[
                            playBracket(client, tourn_channel, bracket[0]),
                            playBracket(client, tourn_channel, bracket[1]),
                        ]
                    )
        ...
        async def playGame(client, tourn_channel, player1, player2):
            ...
            while True:
                ...
                won = await returnCustomGameWinner(
                    destiny_player1.destiny_id,
                    characters1,
                    destiny_player1.system,
