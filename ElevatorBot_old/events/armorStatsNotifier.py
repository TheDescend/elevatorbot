...
from ElevatorBot.core.authfunctions import getVendorData
    ...
    async def run(self, client):
        ...
        def these_are_the_rolls_mystic_likes(
            ...
            if (class_types[item_definition[3]] == "Hunter") and (
                (
                    ...
                    + item_stats[stat_names["Intellect"]]["value"]
                )
                > 50
            ):
                return True
            elif (class_types[item_definition[3]] == "Titan") and (
                (
                ...
                return True
            elif (class_types[item_definition[3]] == "Warlock") and (
                (
                    item_stats[stat_names["Discipline"]]["value"]
                    + item_stats[stat_names["Recovery"]]["value"]
                    + item_stats[stat_names["Intellect"]]["value"]
                )
                > 50
        ...
        async def message_user(
            ...
            for stat_name, statID in stat_names.items():
                embed.add_field(
                    name=stat_name,
                    value=f"Total: {stats[statID]['value']}",
                    inline=True,
                )
        ...
        for character_id in characters:
            ...
            for vendor_name, vendorID in armor_selling_vendors.items():
                res = await getVendorData(
                    destiny_player.discord_id,
                ...
                for saleID, sale in sales.items():
                    ...
                    try:
                        item_definition = await getDestinyDefinition(
                            "DestinyInventoryItemDefinition",
                            definitions[saleID]["itemHash"],
                        )
                    except KeyError:
                        continue
                    ...
                    # kigstn
                    if (
                        (class_types[item_definition[3]] == "Warlock")
                        and (item_stats[stat_names["Recovery"]]["value"] > 20)
                        and (item_stats[stat_names["Discipline"]]["value"] > 20)
                    ):
                        await message_user(
                            client,
                            238388130581839872,
                        ...
                        item_stats[stat_names["Recovery"]]["value"] >= 28
                    ):
                        await message_user(
                            client,
                            238388130581839872,
                        ...
                        (class_types[item_definition[3]] == "Hunter")
                        and (item_stats[stat_names["Recovery"]]["value"] > 20)
                        and (item_stats[stat_names["Mobility"]]["value"] > 20)
                    ):
                        await message_user(
                            client,
                            238388130581839872,
                    ...
                    if (
                        (class_types[item_definition[3]] == "Hunter")
                        and (item_stats[stat_names["Mobility"]]["value"] > 23)
                        and (total_stats > 63)
                    ):
                        await message_user(
                            client,
                    ...
                    if (
                        ...
                        or (item_stats[stat_names["Recovery"]]["value"] > 20)
                        or (item_stats[stat_names["Intellect"]]["value"] > 20)
                    ):
                        await message_user(
                            client,
                            171371726444167168,
                    ...
                    if (class_types[item_definition[3]] == "Hunter") and (
                    ...
                    elif (class_types[item_definition[3]] == "Hunter") and (
                        (
                            item_stats[stat_names["Mobility"]]["value"]
                            + item_stats[stat_names["Recovery"]]["value"]
                            + item_stats[stat_names["Discipline"]]["value"]
                        ...
                        (
                            item_stats[stat_names["Mobility"]]["value"]
                            + item_stats[stat_names["Recovery"]]["value"]
                            + item_stats[stat_names["Strength"]]["value"]
                            + item_stats[stat_names["Resilience"]]["value"]
                        )
                        > 58
                    ):
