...
@router.get("/_get/all", response_model=RolesModel)
...
@router.get("/_get/all/{discord_id}", response_model=EarnedRolesModel)
...
@router.get("/_get/missing/{discord_id}", response_model=MissingRolesModel)
...
@router.get("/_get/{role_id}/{discord_id}", response_model=EarnedRoleModel)
